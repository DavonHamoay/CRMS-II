...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO tblreg (dOwner, dOwned, dVacc,  dRegistrationDate) VALUES (?, ?, ?, ?)");
    ...
    $stmt->bind_param("siis", $dOwnerFullName, $dogsOwned, $dogsVaccinated, $currentDate); 
